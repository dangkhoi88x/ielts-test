...
const Writing_test2 = () => {
  ...
  const TASK1_TOPIC = `The graph below shows the number of tourists visiting a particular Caribbean island between 2010 and 2017.`;
  const TASK2_TOPIC = `In the future, nobody will buy printed newspapers or books because they will be able to read everything they want online without paying.\nTo what extent do you agree or disagree with this statement?`;
      ...
      <div className="container-writing">
        <div className="writing-container">
          ...
          <div className="chart-container">
            <img
              src="../src/assets/Picture/writing_test2.png"
              alt="Number of tourists visiting a Caribbean island (2010-2017)"
